...
def inject_global_css(accent: str = "#4A9EFF"):
    ...
    /* ── TOP NAV (pure HTML — not affected by Streamlit selectors) ── */
    .im-top-nav{{
        background:rgba(1,1,10,0.92);border-radius:14px;border:1px solid rgba(74,158,255,0.12);
        padding:12px 24px;display:flex;align-items:center;justify-content:space-between;
        margin-bottom:12px;backdrop-filter:blur(24px);position:relative;z-index:10
    }}
    ...
    /* ── NAV BAR (pure HTML buttons — not affected by Streamlit selectors) ── */
    .im-nav-bar{{
        display:flex;gap:4px;background:rgba(74,158,255,0.03);border-radius:12px;
        padding:4px;margin-bottom:16px;border:1px solid rgba(74,158,255,0.08);
        flex-wrap:wrap;justify-content:center;position:relative;z-index:10
    }}
    .im-nav-tab{{
        background:transparent;border:1px solid transparent;border-radius:9px;
        font-size:12px;font-weight:600;padding:8px 20px;
        color:rgba(180,210,255,0.45);cursor:pointer;transition:all 0.2s;
        letter-spacing:0.03em;font-family:'Inter',sans-serif;flex:1;text-align:center
    }}
    .im-nav-tab:hover{{
        background:rgba(74,158,255,0.06);color:{accent};
        border-color:rgba(74,158,255,0.15)
    }}
    .im-nav-tab.active{{
        background:rgba(74,158,255,0.1);color:{accent};
        border:1px solid rgba(74,158,255,0.25)
    }}

    /* ── LEGACY NAV CLASSES (keep for compat) ── */
